...
FILES = src/useCases/*.c src/api/*.c src/modules/**/*.c src/lexer/*.c src/utils/*.c

OBJTEST = programa-testes
TESTFILES = src/useCases/*.c src/api/*.c src/modules/**/*.c src/lexer/*.c src/utils/*.c tests/utils/*.c
